...
import io.github.isaevisa05.TGBot.repository.ActiveChatRepository;
...
public class BotService extends TelegramLongPollingBot {
    ...
    private static final String ADD_SPEND = "/addspend";
     ...
     private final ActiveChatRepository activateChatRepository;
    ...
    public void onUpdateReceived(Update update) {
        ...
        try {
            ...
            if(activateChatRepository.findActiveChatByChatId(chatId).isEmpty()) {
                ActiveChat activeChat = new ActiveChat();
                activeChat.setChatId(chatId);
                activateChatRepository.save(activeChat);
            }
        } catch (Exception e) {
    ...
    public void sendNotificationToAllActiveChats(String message, Set<Long> chatIds) {
        for(Long chatId : chatIds) {
            ...
            try {
                ...
                log.error("При отправке сообщения возникла ошибка", e);
            }
        }
    }
    ...
    private String getPreviousCommand(Long chatId) {
        return previousCommands.get(chatId).getLast();
    }
